class Game {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        if (index === player.index) {
          ...
          this.handlePowerCoints(index);
          this.handleCarAColitionWithCarB(index);
  ...
  handleCarAColitionWithCarB(index) {
    if (index === 1) {
  ...
  gameOver() {
    swal({
      title: 'fin del juego',
      text: "Se vacio tu tanque",
      imageUrl: "https://cdn.shopify.com/s/files/1/1061/1924/products/Thumbs_Down_Sign_Emoji_Icon_ios10_grande.png",
      imageSize: "100x100",
      confirmBottonText: "Gracias por jugar"
    })
  }
}